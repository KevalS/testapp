...
class Home extends React.Component {
    constructor(props) {
        ...
        //    AIzaSyB8SBk-sVhmAs4WGf1idOcewKStyC5YPDU
        fetch("https://www.googleapis.com/youtube/v3/search?part=snippet&eventType=live&maxResults=50&type=video&key=AIzaSyAyH0YlJHqOQ5TXQLtloq4gh60n6HBOwzo")
      .then(res => res.json())
      .then((result) => {
          console.log(result)
